...
Si je vous demandais quel est le personnage central du dernier roman que vous avez lu, selon le roman en question, la réponse pourrait être évidente — ou non. Qu’entend-on par «central»? Désigne-t-on par là le personnage qui est en relation avec le plus grand nombre d'individus? Celui qui est entouré des personnages qui comptent le plus? Celui par qui transite l'information entre divers groupes?
